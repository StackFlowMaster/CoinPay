...
const rows = [
    createData('India', 'IN', 1324171354, 3287263, 10, 20, 2, 0, 0),
    createData('China', 'CN', 1403500365, 9596961, 10, 20, 2, 0, 0),
    createData('Italy', 'IT', 60483973, 301340, 10, 20, 2, 0, 0),
];
...
const BetHistoryTable = props => {
    ...
    const columns = [
        {id: 'draw', label: t("bet_history_table.draw"), minWidth: 170, align: 'center' },
        {id: 'lottery', label: t("bet_history_table.lottery"), minWidth: 170, align: 'center' },
